...
fun getFilterList(context: Context) = listOf(
    FunctionItem(index = INDEX_ORIGINAL, icon = R.drawable.img_filter_original, name = context.getString(R.string.filter_original), labelBgColor = context.getColor(R.color.filter_color_grey_light)),
